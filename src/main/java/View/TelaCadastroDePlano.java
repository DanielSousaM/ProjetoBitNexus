...
public class TelaCadastroDePlano extends javax.swing.JFrame {
    ...
    private void cadastroPlanoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cadastroPlanoActionPerformed
        // TODO add your handling code here:
        Cadastrodeplano cadastroDePlano = new Cadastrodeplano();
         
      cadastroDePlano.setNomePlano((String)nomeplano.getText());
      cadastroDePlano.setDescricaoplano((String)descricaoPlano.getText());
      cadastroDePlano.setValorPlano(Double.parseDouble(valorPlano.getText()));
      cadastroDePlano.setTaxaPlano(Double.parseDouble(taxaPlano.getText()));
      cadastroDePlano.setStatusPlano((String)statusplano.getText());
      
      boolean result = controler.Cadastrodeplano(cadastroDePlano);
      
      if(controler.Cadastrodeplano(cadastroDePlano)){
